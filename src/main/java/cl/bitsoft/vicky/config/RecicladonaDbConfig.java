package cl.bitsoft.vicky.config;
...
@Configuration
@ConfigurationProperties(prefix = "spring.recicladona.datasource")
...
public class RecicladonaDbConfig extends HikariConfig {
    ...
    public PlatformTransactionManager stockTransactionManager(
            @Qualifier("recicladonaEntityManager") EntityManagerFactory entityManagerFactory) {
